...
/// <summary>
/// Decodificador de PSK250 (Phase Shift Keying a 250 baudios) que implementa <see cref="IDecodificadorDigital"/>.
/// Pipeline de procesamiento:
/// 1. Recibe bloques de audio PCM de 16 bits.
/// 2. Multiplica la senal por portadoras de referencia I (coseno) y Q (seno).
/// 3. Integra sobre un periodo de bit (48 muestras a 12000 Hz / 250 baudios).
...
/// </summary>
public sealed class DecodificadorPsk250 : IDecodificadorDigital
{
    private readonly ConfiguracionPsk250 _configuracion;
    ...
    /// <summary>
    /// Crea una nueva instancia del decodificador PSK250.
    /// </summary>
    /// <param name="configuracion">Configuracion del decodificador. Si es null se usa la configuracion por defecto.</param>
    public DecodificadorPsk250(ConfiguracionPsk250? configuracion = null)
    {
        _configuracion = configuracion ?? new ConfiguracionPsk250();
                    ...
                    if (caracter.Value == '\n' || _textoDecodificado.Length >= 80)
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(texto))
                        {
                            MensajeDecodificado mensaje = new(
                                ...
                                texto: texto,
                                subModo: SubModoOperacion.PSK250);
