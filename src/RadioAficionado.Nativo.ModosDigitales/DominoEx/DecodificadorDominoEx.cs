...
/// <summary>
/// DominoEX (Incremental Frequency Keying) — modo digital robusto.
...
/// </summary>
public sealed class DecodificadorDominoEx : IDecodificadorDigital
{
    private readonly ConfiguracionDominoEx _configuracion;
    ...
    /// <inheritdoc />
    public ModoOperacion Modo => ModoOperacion.DOMINO;

    /// <inheritdoc />
    public IReadOnlyList<SubModoOperacion> SubModosSoportados { get; } = new List<SubModoOperacion>
    {
        SubModoOperacion.DOMINOEX4,
        SubModoOperacion.DOMINOEX8,
        SubModoOperacion.DOMINOEX16
    }.AsReadOnly();
    ...
    /// <summary>
    /// Crea una nueva instancia del decodificador DominoEX.
    /// </summary>
    /// <param name="configuracion">Configuracion del decodificador. Si es null se usa DominoEX11.</param>
    public DecodificadorDominoEx(ConfiguracionDominoEx? configuracion = null)
    {
        _configuracion = configuracion ?? new ConfiguracionDominoEx();
    ...
    /// <summary>
    /// Determina el submodo de DominoEX segun la configuracion actual (BaudRate).
    /// </summary>
    ...
    private SubModoOperacion DeterminarSubModo()
    {
        ...
        {
            <= 5.0 => SubModoOperacion.DOMINOEX4,
            <= 10.0 => SubModoOperacion.DOMINOEX8,
            _ => SubModoOperacion.DOMINOEX16
        };
    }
